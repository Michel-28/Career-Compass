...
'use server';
/**
 * @fileOverview A flow for generating interview questions based on a resume and job role.
 *
...
const prompt = ai.definePrompt({
  ...
  Given a resume and a job role, you will generate a list of relevant interview questions.
